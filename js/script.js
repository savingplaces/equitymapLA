...
/////////////////Add Population Census Tract Data//////////////////////////
        ...
        var popTracts = new FeatureLayer({
          url:"https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/aachaf_la_tract10_select/FeatureServer",
          maxScale: 0,
          minScale: 0,   
...
/**************************Add Non-Study Census Tracts******************************/
        ...
        var nonStudyTracts = new FeatureLayer({
          url:"https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/LA_NonStudy_Tracts/FeatureServer",
          maxScale: 0,
          minScale: 0,
          opacity: 1,
          renderer: {  
...
/**************************Add HAAN Tracts******************************/
        ...
        var Haan = new FeatureLayer({
          url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/LA_HAAN/FeatureServer",
          maxScale: 0,
          minScale: 0,
          visible: true,     
          legendEnabled: true,    
...
/**************************Add HTC Project Points******************************/
        ...
        var htcProj = new FeatureLayer ({
            ...
            definitionExpression: "city = 'Los Angeles' AND state = 'CA' AND part3 >= '2009-01-01 00:00:00' AND part3 <= '2016-12-31 00:00:00'",
            maxScale: 0,
            minScale: 500000,
            visible: false,
            popupEnabled: true, 
...
/**************************Add Local HDs******************************/
        ...
        var localHd = new FeatureLayer({
          url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/LA_Local_Historic_Districts/FeatureServer",   
          maxScale: 0,
          minScale: 500000,
          opacity: 0.9,    
          legendEnabled: true,
...
/**************************Add NRHP Sites******************************/
        ...
        var nrhpSites = new FeatureLayer({
          url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/LA_NRHP_Buildings/FeatureServer",
...
/**************************Add NRHP HDs******************************/
        ...
        var nrhpHd = new FeatureLayer({
          url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/LA_National_Register_Historic_Districts/FeatureServer",
          definitionExpression: "resource = 'Historic District'",
          maxScale: 0,
          minScale: 500000,
          opacity: 0.9,    
          legendEnabled: true,
...
/**************************Add Public Transportation Stations Layer******************************/
       ...
       const ctaLabel = {    
        ...
        var ctaStations = new FeatureLayer ({
            url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/LAMetro_Stations/FeatureServer",
            maxScale: 0,
            minScale: 100000,
            legendEnabled: true,
            visible: false,
        ...
        const ctaRenderer = {
          ...
          uniqueValueInfos: [{
            ...
            value: "Expo/Blue",
            symbol: groupExpoBlue,
            label: "Expo / Blue Line"
          }, {
            value: "Gold",
            symbol: groupGold,
            label: "Gold Line"
            ...
            value: "Red/Purple",
            symbol: groupRedPurple,
            label: "Red / Purple Line"
          }, {
            value: "RegCon",
            symbol: groupRegCon,
            label: "Regional Connector"
          }],
        };
    
        
        var ctaLines = new FeatureLayer({
          url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/LAMetro_Lines/FeatureServer",
          maxScale: 0,
          minScale: 500000,
          definitionExpression: "LINE IN ('Blue', 'Crenshaw / LAX', 'Expo', 'Expo/Blue', 'Gold', 'Green', 'Orange', 'Purple', 'Red', 'Red/Purple')",    
          opacity: 0.8,    
          legendEnabled: true,
          visible: false,
          popupTemplate: {
                content: 
                "<table style='width:100%'><tbody><tr style='border:0px solid'><td align='center' style='padding:2px'><h3>BART Transit Line</h3></td></tr></tbody></table>"+"<table style='border:2px solid #b8b8b8; border-collapse:collapse; width:100%'><tbody><tr style='border:2px solid #d1d1d1'><td align='left' colspan='2' style='background-color: #d8cebc ;padding:5px'><h4>{LINE}</h4></td></tbody></table><br>"
            },    
          popupEnabled: true,
        ...
        var collUniv = new FeatureLayer ({
            url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/LAUniversities_and_Colleges/FeatureServer",
            maxScale: 0,
            minScale: 500000,
            visible: false,
            legendEnabled: true,
       ...
       const demoRenderThree = {
        ...
        var demoPermits = new FeatureLayer ({
           url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/LA_Demo_Permits/FeatureServer",
           featureReduction: makeCluster,
           definitionExpression: "Issue_Date < '1/01/2017'",    
           ...
           popupTemplate: {
                content: 
                "<table style='width:100%'><tbody><tr style='border:0px solid;'><td align='center' style='padding:2px'><h3>Demolition Permit</h3></td></tr></tbody></table>"+"<table style='border:2px solid #d1d1d1; border-collapse:collapse; width:100%'><tbody><tr style='border:2px solid #d1d1d1'><td align='center' colspan='2' style='background-color: #d8cebc ;padding:5px'><b><h4>Permit Information</h4></td></tr><tr><td align='center' style='text-align: center; border: 1px solid #d1d1d1; padding: 5px;' width='30%'><h5>Type</h5></td><td align='center' style='padding:5px; border: 1px solid #d1d1d1;' width='70%'><h6>Demolition</h6></td></tr><tr><td align='center' style='text-align: center; border: 1px solid #d1d1d1; padding: 5px;' width='30%'><h5>Issue Date</h5></td><td align='center' style='padding:5px; border: 1px solid #d1d1d1;' width='70%'><h6>{Issue_Date}</h6></td></tr><tr><td align='center' style='text-align: center; border: 1px solid #d1d1d1; padding: 5px;' width='30%'><h5>Address</h5></td><td align='center' style='padding:5px; border: 1px solid #d1d1d1;' width='70%'><h6>{Address_En} {Street_Dir} {Street_Nam} {Street_Suf}</h6></td></tr><tr><td align='center' style='text-align: center; border: 1px solid #d1d1d1; padding: 5px;' width='30%'><h5>Description</h5></td><td align='center' style='padding:5px; border: 1px solid #d1d1d1;' width='70%'><h6>{Work_Descr}</h6></td></tr></tbody></table><br>"
                }
        });
...
/****************************Red Line Data*************************/
        ...
        var redLine = new FeatureLayer({
          url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/LosAngeles_Redline/FeatureServer",
          maxScale: 0,
          minScale: 500000,
          opacity: 0.8,    
          legendEnabled: true,
...
/**************************Add Neighborhood Boundaries******************************/
        ...
        var allNeighbor = new FeatureLayer({
          url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/LA_Neighborhoods/FeatureServer", 
          maxScale: 0,
          minScale: 0,
          opacity: 1,    
          legendEnabled: true,
...
/*        const group_1 = {
        ...
        const farRenderer = {
          ...
          field: "ZoneGen",
          legendOptions: {
            title: "Oakland Zoning Districts"
          },
          //defaultSymbol: { type: "simple-fill" },  
          uniqueValueInfos: [{
            value: "Special and Combined",
            symbol: group_1,
            label: "Special and Combined Zoning"
          }, {
            value: "Industrial",
            symbol: group_2,
            ...
            value: "Open Space",
            symbol: group_5,
            label: "Open Space Zoning"
          }],
        };
    
        var zoningBounds = new FeatureLayer({
          url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/Oakland_Zoning/FeatureServer",
          maxScale: 0,
          minScale: 500000,
          opacity: 0.5,    
          legendEnabled: true,
          ...
          popupTemplate: ({
                content: [
                    {
                        type: "text",
                        text: "<table style='width:100%'><tbody><tr style='border:0px solid'><td align='center' style='padding:2px'><h3>Zoning Districts</h3></td></tr></tbody></table>"+"<table style='border:2px solid #b8b8b8; border-collapse:collapse; width:100%'><tbody><tr style='border:2px solid #d1d1d1'><td align='left' colspan='2' style='background-color: #d8cebc ;padding:5px'><h4>{ZoneDescr} ({basezone})</h4></td></tr><tr><td align='center' style='text-align: center; border: 1px solid #d1d1d1; padding: 5px;' width='30%'><h5>More Information</h5></td><td align='center' style='padding:5px; border: 1px solid #b8b8b8;' width='70%'><h6><a href='https://www.oaklandca.gov/topics/planning-code-zoning-map-and-general-plan#zoning-information-159670' target='_blank'>Learn more about Oakland Zoning Districts</a></h6></td></tr></tbody></table><br>"
                    }
                ],
              expressionInfos: arcadeExpressionInfos
            }),    
        ...
        var cityLimits = new FeatureLayer({
          url: "https://services3.arcgis.com/8mRVhBBtAu5eqZUu/arcgis/rest/services/LA_Boundary/FeatureServer",
          legendEnabled: false,
          visible: true,
          maxScale: 0,
          minScale: 0,
        ...
        map.addMany([cartoBasemap, nonStudyTracts, popTracts, housingTracts, incomeTracts, nrhpHd, localHd, Haan, allNeighbor, redLine, ctaLinesBack, ctaLines, ctaStations, collUniv, cityLimits, demoPermits, nrhpSites, htcProj]);  
...
/***********************Search Widgets************************/
        ...
        var nrhpHdSearch = new Search({
                ...
                sources: [
                    {
                        layer: nrhpHd,
                        searchFields: ["prime_name"],
                        displayField: "prime_name",
                        exactMatch: false,
                        placeholder: "Enter a District Name",
